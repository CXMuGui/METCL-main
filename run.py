...
from data_process.data_manage import DataManager
from src import method_map
from utils.util import set_torch_seed, save_results, set_output_path
...
def parse_arguments():
    ...
    parser.add_argument('--method', type=str, default='METCL', help="which method to use.")
    ...
    parser.add_argument("--data_path", default = 'your/path/Datasets', type=str,
    ...
    parser.add_argument("--config_file_name", type=str, default='METCL_MIntRec.py', help = "The name of the config file.")
