...
from mamba_ssm.modules.mamba_simple_gui import Mamba
...
class InterMamba(nn.Module):
    ...
    def forward(self, pan, ms):
        ...
        pan = rearrange(pan, 'b l d -> b d l')
        ms = rearrange(ms, 'b l d -> b d l')
        ...
        pan = rearrange(pan, 'b d l -> b l d')
        ms = rearrange(ms, 'b d l -> b l d')
        output = rearrange(fusion, 'b d l -> b l d')
