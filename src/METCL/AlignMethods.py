...
__all__ = ['CTCModule', 'AlignModule', 'SimModule']
...
class AlignModule(nn.Module):
    def __init__(self, args, mode):
        ...
        if mode == 'conv1d':
            ...
            self.sim_t =\
                SimModule(in_dim_t, self.dst_dim, self.shared_dim, self.dst_len, args)
            self.sim_v =\
                SimModule(in_dim_v, self.dst_dim, self.shared_dim, self.dst_len, args)
            self.sim_a =\
                SimModule(in_dim_a, self.dst_dim, self.shared_dim, self.dst_len, args)
